...
program2.name("remote-sdk-host").description("Host a Remote SDK session via Dev Tunnels").version(VERSION).option("-d, --debug", "Enable verbose debug logging").option("-p, --port <number>", "Port for local SDK connection", "0").action(runHost);
